...
Funciones auxiliares para manipulación y preparación de imágenes
...
class ImageProcessor:
    ...
    def create_mask_from_bbox(self, image: Image.Image, bbox: Tuple[int, int, int, int]) -> Image.Image:
    ...
    def calculate_image_metrics(self, image: Image.Image) -> Dict[str, Any]:
        ...
        # Calcular contraste (diferencia entre max y min)
    ...
    def compare_images(self, img1: Image.Image, img2: Image.Image) -> Dict[str, Any]:
        ...
        # Calcular similitud (1 - diferencia normalizada)
        similarity = max(0, 1 - (total_diff / 255))
        
        # Calcular PSNR (Peak Signal-to-Noise Ratio) aproximado
